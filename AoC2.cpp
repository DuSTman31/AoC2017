// AoC2.cpp : Defines the entry point for the console application.
//
...
int getSmallest(vector<int> &a) {
	bool found = false;
	int smallest = 0;

	for (auto sIter = a.begin() ; sIter!=a.end() ; sIter++) {
		int value = *sIter;
		if (!found) {
			found = true;
			smallest = value;
...
{
	int sum = 0;
	vector<vector<int>> values = { { 1136, 1129, 184, 452, 788, 1215, 355, 1109, 224, 1358, 1278, 176, 1302, 186, 128, 1148},
